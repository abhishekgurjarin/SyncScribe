...
#### [NEW] [schema.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/db/schema.ts)
...
#### [NEW] [migrations/](file:///c:/Abhishek/Assignment/SyncScribe/src/db/migrations/)
...
#### [NEW] [auth.ts](file:///c:/Abhishek/Assignment/SyncScribe/auth.ts)
...
#### [NEW] [proxy.ts](file:///c:/Abhishek/Assignment/SyncScribe/proxy.ts)
- Route protection: redirect unauthenticated users from `/dashboard`, `/editor/*` to `/auth/signin`
- Public routes: `/`, `/auth/*`, `/api/auth/*`

#### [NEW] [src/lib/authorization.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/authorization.ts)
...
#### [NEW] [src/lib/crdt/yjs-provider.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/crdt/yjs-provider.ts)
...
#### [NEW] [src/lib/crdt/sync-manager.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/crdt/sync-manager.ts)
...
#### [NEW] [src/lib/crdt/awareness.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/crdt/awareness.ts)
...
#### [NEW] [src/lib/versioning/version-manager.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/versioning/version-manager.ts)
...
#### [NEW] [src/components/version-history/](file:///c:/Abhishek/Assignment/SyncScribe/src/components/version-history/)
...
#### [NEW] [server/ws-server.ts](file:///c:/Abhishek/Assignment/SyncScribe/server/ws-server.ts)
...
#### [NEW] [server/rate-limiter.ts](file:///c:/Abhishek/Assignment/SyncScribe/server/rate-limiter.ts)
...
#### [NEW] [src/components/editor/](file:///c:/Abhishek/Assignment/SyncScribe/src/components/editor/)
...
#### [NEW] [src/app/(public)/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/(public)/page.tsx)
...
#### [NEW] [src/app/auth/signin/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/auth/signin/page.tsx)
- Sign in with GitHub, Google, or email/password
- Beautiful auth card with animated background

#### [NEW] [src/app/auth/signup/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/auth/signup/page.tsx)
- Registration form with validation

#### [NEW] [src/app/dashboard/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/dashboard/page.tsx)
...
#### [NEW] [src/app/editor/[documentId]/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/editor/[documentId]/page.tsx)
...
#### [NEW] [src/app/editor/[documentId]/versions/page.tsx](file:///c:/Abhishek/Assignment/SyncScribe/src/app/editor/[documentId]/versions/page.tsx)
...
#### [NEW] [src/app/api/ai/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/ai/route.ts)
- Server-side AI endpoint with streaming

#### [NEW] [src/lib/ai/actions.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/lib/ai/actions.ts)
...
#### [NEW] [src/app/api/documents/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/documents/route.ts)
- `GET` — List user's documents (owned + collaborated)
- `POST` — Create new document (with Zod validation)

#### [NEW] [src/app/api/documents/[id]/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/documents/[id]/route.ts)
- `GET` — Get document metadata + check access
- `PATCH` — Update document metadata (title, public flag)
- `DELETE` — Delete document (owner only)

#### [NEW] [src/app/api/documents/[id]/versions/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/documents/[id]/versions/route.ts)
- `GET` — List versions with pagination
- `POST` — Create named snapshot (with binary payload size limit: 5MB)

#### [NEW] [src/app/api/documents/[id]/versions/[versionId]/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/documents/[id]/versions/[versionId]/route.ts)
- `GET` — Get specific version snapshot
- `POST /restore` — Restore document to this version

#### [NEW] [src/app/api/documents/[id]/collaborators/route.ts](file:///c:/Abhishek/Assignment/SyncScribe/src/app/api/documents/[id]/collaborators/route.ts)
...
#### [NEW] [.github/workflows/ci.yml](file:///c:/Abhishek/Assignment/SyncScribe/.github/workflows/ci.yml)
- Lint (ESLint)
...
#### [NEW] [src/__tests__/](file:///c:/Abhishek/Assignment/SyncScribe/src/__tests__/)
